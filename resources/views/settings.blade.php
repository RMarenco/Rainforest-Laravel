        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              @if (app()->getLocale() == 'en')
                <h3 class="m-0 font-weight-bold text-primary">{{ $user->name }}'s {{ __('messages.profile') }}</h3>
              @elseif (app()->getLocale() == 'es')
                <h3 class="m-0 font-weight-bold text-primary">{{ __('messages.profile') }} de {{ $user->name }}</h3>
              @endif              
            </div>
            <div class="card-body">
              <div class="text-center">     
                <img src="uploads/avatars/{{ $user->avatar }}" onerror="this.src='../uploads/avatars/avatar.png'" id="custom-img-button" width="150px" height="150px" style="border-radius:50%; cursor: pointer;  border-style:outset; border-width: 5px; border-color: #d63031 #0984e3">       
                <!--<img src="Gallery/avatar.png" height="150px" width="150px" class="avatar img-circle" alt="avatar">-->     
              </div>
              <form class="form-horizontal" action="{{URL::to('/profile')}}" method="post" enctype="multipart/form-data">                   
                <br/>
                <div class="form-group">
                  ...
                  <div class="col-lg-10 col-sm-9 col-md-9 col-8" style="float: left; padding-right: 0">
                    @if (app()->getLocale() == 'en')
                      <span id="custom-text" style="cursor:pointer" class="form-control">{{ __('messages.file') }}.</span>
                    @elseif (app()->getLocale() == 'es')
                      <span id="custom-text" style="cursor:pointer" class="form-control">{{ __('messages.file') }}.</span>
                    @endif                     
                  </div>
                  <div class="col-lg-2 col-sm-3 col-md-3 col-4" style="float: right; padding-left: 0">
                    @if (app()->getLocale() == 'en')
                      <span class="btn btn-success form-control" id="custom-button">{{ __('messages.file-btn') }}</span>
                    @elseif (app()->getLocale() == 'es')
                      <span class="btn btn-success form-control" id="custom-button">{{ __('messages.file-btn') }}</span>
                    @endif
                  </div>
                ...
                <div class="form-group">
                  ...
                  @endif 
                  <div class="col-lg-12">
                    <input disabled="true" class="form-control" type="text" placeholder="{{ $user->name }}">
                  </div>
                </div>
                <div class="form-group">            
                  <?php
                  ...
                  ?>
                  @if (app()->getLocale() == 'en')
                    <label class="col-md-3 control-label">Current {{ __('messages.username') }}:</label>
                  @elseif (app()->getLocale() == 'es')
                    <label class="col-md-3 control-label">{{ __('messages.username') }} Actual:</label>
                  @endif 
                  <div class="col-lg-12">                    
                ...
                <div class="form-group">
                  @if (app()->getLocale() == 'en')
                    <label class="col-md-3 control-label">{{ __('messages.username') }}:</label>
                  @elseif (app()->getLocale() == 'es')
                    <label class="col-md-3 control-label">{{ __('messages.username') }}:</label>
                  @endif 
                  <div class="col-lg-12">
                    @if (app()->getLocale() == 'en')
                      <input class="form-control" type="text" name="username" placeholder="{{ __('messages.username') }}">
                    @elseif (app()->getLocale() == 'es')
                      <input class="form-control" type="text" name="username" placeholder="{{ __('messages.username') }}">
                    @endif                 
                  </div>
                ...
                <div class="form-group">
                  @if (app()->getLocale() == 'en')
                    <label class="col-md-3 control-label">Actual {{ __('messages.password') }}:</label>
                  @elseif (app()->getLocale() == 'es')
                    <label class="col-md-3 control-label">{{ __('messages.password') }} Actual:</label>
                  @endif 
                  <div class="col-md-12">
                ...
                <div class="form-group">
                  @if (app()->getLocale() == 'en')
                    <label class="col-md-3 control-label">{{ __('messages.password') }}:</label>
                  @elseif (app()->getLocale() == 'es')
                    <label class="col-md-3 control-label">{{ __('messages.password') }}:</label>
                  @endif                  
                  <div class="col-md-12">
                ...
                <div class="form-group">
                  @if (app()->getLocale() == 'en')
                    <label class="col-md-3 control-label">{{ __('messages.confirm') }}{{ __('messages.password') }}:</label>
                  @elseif (app()->getLocale() == 'es')
                    <label class="col-md-3 control-label">{{ __('messages.confirm') }} la {{ __('messages.password') }}:</label>
                  @endif
                  <div class="col-md-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-12">
                    @if (app()->getLocale() == 'en')
                      <input type="submit" name="submit" class="btn btn-primary" value="{{ __('messages.save-changes') }}">
                    @elseif (app()->getLocale() == 'es')
                      <input type="submit" name="submit" class="btn btn-primary" value="{{ __('messages.save-changes') }}">
                    @endif
                    <span></span>
                    @if (app()->getLocale() == 'en')
                      <input type="reset" class="btn btn-secondary" value="{{ __('messages.reset') }}">
                    @elseif (app()->getLocale() == 'es')
                      <input type="reset" class="btn btn-secondary" value="{{ __('messages.reset') }}">
                    @endif                    
                  </div>
