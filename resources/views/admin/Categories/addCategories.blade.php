                ...
                <div class="col-xl-12">
                  <div class="p-5">
                    <div class="text-center">
                      <h1 class="h4 text-gray-900 mb-4" style="margin-left:1%;">Add Categories</h1>
                    </div>
                    <form class="user" action="{{ route('add_categories') }}" method="POST" enctype="multipart/form-data">                        
                      <input type="hidden" name="_token" value="{{ csrf_token()}}">   
                      <div class="form-group">
                        <input class="form-control form-control-user" type="text" name="category" style="margin-bottom: 15px" value="{{ old('category') }}" placeholder="add category name" required>
                      </div>  
                      @if(Session::has('errors'))
                      <div class="col-lg-12">
                        <div class="alert alert-danger" style="font-size: .8rem;border-radius: 10rem;padding: .75rem 1rem;">
                          {{ Session::get('errors') }}
                        </div>
                      </div>
                      @endif                          
