                  ...
                  <div class="col-xl-12">
                    <div class="p-5">
                      <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4" style="margin-left:1%;">Add Admins</h1>
                      </div>
                      <form class="user" action="{{ route('add_admins') }}" role="form" method="POST" enctype="multipart/form-data">                  
                        ...
                        <div class="form-group row">
                          <div class="col-sm-6 mb-3 mb-sm-0">
                            ...
                            $query = mysqli_query($conn, "SELECT id, name FROM users WHERE isAdmin = 0");
                            echo "<select id='id' name='id' class='form-control' style='font-size: .8rem; border-radius: 10rem; height:3rem; margin-bottom:15px;' required>";
                            echo "<option disabled selected value>Choose a user</option>";
                            while($d = mysqli_fetch_assoc($query)){?>            
                              <option value="<?=$d['id']?>"><?=utf8_encode($d['name']);?></option>
                            <?php
                            }
                              echo "</select>";
                            ?>
                          ...
                          <div class="col-sm-6 mb-3 mb-sm-0">
                            <select id='isAdmin' name='isAdmin' class='form-control' style='font-size: .8rem; border-radius: 10rem; height:3rem; margin-bottom:15px;' required>
                              <option disabled selected value>Choose a level of admin</option>
                              <option value="1">Admin</option>
                            </select>               
                          </div>                          
                        </div>
                        <input type="submit" class="btn btn-primary btn-user btn-block" value="add admin">
                      </form>
                    </div>
                  </div>
                </div>
