              ...
              <div class="row">
                <div class="col-xl-12">
                  <div class="p-5">
                    ...
                    <form class="user" action="<?php echo e(route('add_product')); ?>" role="form" method="POST" enctype="multipart/form-data">
...
</html><?php /**PATH D:\rainforest\resources\views/User-Seller/Products/addproduct.blade.php ENDPATH**/ ?>